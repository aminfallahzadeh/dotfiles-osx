	...
	config = function()
		...
		require("bufferline").setup({
			highlights = {
				...
				error = {
					fg = is_light_mode and colors.maroon or colors.maroon,
					bg = colors.none,
					bold = false,
					italic = false,
				},
				...
				error_selected = {
					fg = is_light_mode and colors.red or colors.red,
					bg = colors.none,
					bold = false,
					italic = false,
				},
				...
				warning = {
					fg = is_light_mode and colors.yellow or colors.yellow,
					bg = colors.none,
					bold = false,
					italic = false,
				},
				...
				warning_selected = {
					fg = is_light_mode and colors.peach or colors.peach,
					bg = colors.none,
					bold = false,
					italic = false,
				},
				hint = {
					fg = is_light_mode and colors.green or colors.green,
					bg = colors.none,
					bold = false,
					italic = false,
				},
				...
				hint_selected = {
					fg = is_light_mode and colors.teal or colors.teal,
					bg = colors.none,
					bold = false,
					italic = false,
				},
				...
				info = {
					fg = is_light_mode and colors.sky or colors.sky,
					bg = colors.none,
					bold = false,
					italic = false,
				},
				...
				info_selected = {
					fg = is_light_mode and colors.sapphire or colors.sapphire,
					bg = colors.none,
					bold = false,
					italic = false,
				},
